...
return frozen({
	...
	Routes = frozen({
		...
		ServiceWidth = 18,
		-- Service lanes begin/end slightly inside the freight endpoints. Their
		-- frequent small direction changes make them ~607 studs vs ~618 freight:
		-- a little shorter, but less forgiving for unstable giant piles.
		LeftService = frozen({
			Vector3.new(-186, 0, 292),
			Vector3.new(-174, 0, 247),
			Vector3.new(-186, 0, 197),
			Vector3.new(-174, 0, 147),
			Vector3.new(-186, 0, 97),
			Vector3.new(-174, 0, 47),
			Vector3.new(-186, 0, -3),
			Vector3.new(-174, 0, -53),
			Vector3.new(-186, 0, -103),
			Vector3.new(-174, 0, -153),
			Vector3.new(-186, 0, -203),
			Vector3.new(-174, 0, -253),
			Vector3.new(-186, 0, -298),
		}),
		RightService = frozen({
			Vector3.new(186, 0, 292),
			Vector3.new(174, 0, 247),
