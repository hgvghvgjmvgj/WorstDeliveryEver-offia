...
return table.freeze({
	...
	Tracks = table.freeze({
		...
		Control = table.freeze({
			...
			Description = "Handle unstable stacks with better control and recovery.",
			Levels = table.freeze({
				level(1.00, 0),
				level(1.10, 800),
				level(1.22, 1_800),
		...
		Mobility = table.freeze({
			...
			Description = "Move faster while searching; overloaded returns suppress most of the bonus.",
			Levels = table.freeze({
				level(16.0, 0),
				level(17.5, 700),
				level(19.0, 1_600),
