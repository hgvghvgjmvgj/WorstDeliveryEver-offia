...
function Controller.Start(uiController: any)
	...
	RunService.RenderStepped:Connect(function(dt)
		...
		if grabButton then
			...
			grabButton.Size = if UserInputService.TouchEnabled then UDim2.fromOffset(78, 78) else UDim2.fromOffset(96, 96)
		end

		local ditchButton = ContextActionService:GetButton("OneTripDrop")
		if ditchButton then
			ditchButton.Size = if UserInputService.TouchEnabled then UDim2.fromOffset(64, 64) else UDim2.fromOffset(78, 78)
		end
	end)
end
